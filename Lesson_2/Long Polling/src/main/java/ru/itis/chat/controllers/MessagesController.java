...
@RestController
//Аббревиатура REST расшифровывается как representational state transfer — «передача состояния представления» или,
//лучше сказать, представление данных в удобном для клиента формате.
